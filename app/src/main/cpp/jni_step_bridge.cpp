...
namespace {
constexpr const char* kLogTag = "FreeCADStepIo";
...
std::string exceptionMessage() {
    try {
        ...
        return "Unknown STEP import error";
    }
}
...
jobject makePayload(
    ...
    if (payloadClass == nullptr) {
        throw std::runtime_error("NativeStepPayload class was not found");
    }
    ...
    if (constructor == nullptr) {
        throw std::runtime_error("NativeStepPayload constructor was not found");
    }
...
Java_com_medinaparra_freecadandroid_nativebridge_NativeStepBridge_nativeImportStep(
    JNIEnv* env,
    jobject,
    jstring localPath,
    ...
    try {
        const fcandroid::StepImportResult result = fcandroid::StepIo::importFile(
